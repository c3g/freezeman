# Generated by Django 4.2.4 on 2024-11-25 20:18
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('extracted_readset', models.ForeignKey(help_text='Readset for which the data has been prepared.', on_delete=django.db.models.deletion.PROTECT, related_name='production_tracking', to='fms_core.readset')),
            ],
        ),
        migrations.CreateModel(
            name='MetricField',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('principal_investigator', models.CharField(help_text='Principal investigator of the project.', max_length=200)),
                ('taxon', models.CharField(help_text='Taxon scientific name.', max_length=200)),
                ...
                ('library_batch', models.ForeignKey(help_text='Process that generated the library.', on_delete=django.db.models.deletion.PROTECT, related_name='production_data', to='fms_core.process')),
            ],
            options={
