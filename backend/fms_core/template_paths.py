...
EXPERIMENT_INFINIUM_TEMPLATE = static("submission_templates/Experiment_Infinium_24_v3_6_0.xlsx")
EXPERIMENT_MGI_TEMPLATE = static("submission_templates/Experiment_run_MGI_v3_6_0.xlsx")
...
SAMPLE_QC_TEMPLATE = static("submission_templates/Sample_QC_v3_5_0.xlsx")
