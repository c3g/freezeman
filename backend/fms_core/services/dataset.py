...
def create_validation_info_file(dataset_obj: Dataset, is_validation_revocation: bool = False):
    ...
    validated_data = {"data_release_action": file_prefix[is_validation_revocation], "external_project_id": external_project_id, "run_id": dataset_obj.experiment_run.id, "dataset_id": dataset_obj.id, "lane": dataset_obj.lane, "files": {}}
...
def create_release_info_file(dataset_obj: Dataset, readsets_obj: List[Readset], is_release_revocation: bool = False):
    ...
    released_data = {"data_release_action": file_prefix[is_release_revocation], "external_project_id": external_project_id, "run_id": dataset_obj.experiment_run.id, "dataset_id": dataset_obj.id, "lane": dataset_obj.lane, "files": {}}
