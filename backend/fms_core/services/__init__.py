...
#TODO: (possibly create a dataclass that would return the tuples)

'''
    Services functions should return a tuple (object, list_of_objects [optional], list_of_errors, list_of_warnings) 
