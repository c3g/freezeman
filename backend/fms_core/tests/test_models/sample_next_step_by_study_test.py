...
class SampleNextStepByStudyTest(TestCase):
    def setUp(self):
        ...
        self.step_after = Step.objects.get(name="Experiment Run Illumina")
        ...
        self.step_order_after = StepOrder.objects.get(order=8, workflow=self.workflow, step=self.step_after)
