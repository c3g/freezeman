...
class SampleSubmissionTestCase(TestCase):
    def setUp(self) -> None:
        ...
        self.file = APP_DATA_ROOT / "Sample_submission_v4_1_0.xlsx"
        ContentType.objects.clear_cache()

        self.project_name = "TEST_PROJECT"
        self.workflow_name = "PCR-free Illumina"

        self.invalid_template_tests = ["Sample_submission_v4_1_0_bad_location.xlsx",
                                       "Sample_submission_v4_1_0_dna_no_conc.xlsx",
                                       "Sample_submission_v4_1_0_library_without_index.xlsx",]
