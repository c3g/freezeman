                ...
                for filename in content_zipped.namelist():
                    if filename[-5:] != ".xlsx":  # At the moment we only test the csv output files.
                        ...
                        if filename.find("Container_Mapping_") != -1:
                            ...
                            self.assertEqual(csv_content[1][2], "TubeDst")
                            ...
                            self.assertEqual(csv_content[2][2], "TubeDst")
                            ...
                            self.assertEqual(csv_content[3][2], "TubeDst")
                            ...
                            self.assertEqual(csv_content[4][2], "TubeDst")
                            ...
                            self.assertEqual(csv_content[5][2], "TubeDst")
                            ...
                            self.assertEqual(csv_content[6][2], "TubeDst")
                            ...
                            self.assertEqual(csv_content[7][2], "TubeDst")
                            ...
                            self.assertEqual(csv_content[8][2], "TubeDst")
                            ...
                            self.assertEqual(csv_content[9][2], "TubeDst")
                            ...
                            self.assertEqual(csv_content[10][2], "TubeDst")
