...
def custom_prefill_8x12_container_biosample_names(workbook_sheet, sheet_info, header_offset, rows_dicts):
    SOURCE_BARCODE_FIELD = "Source Container Barcode"
    SOURCE_COORDINATE_FIELD = "Source Container Coord"
    DEST_COORDINATE_FIELD = "Destination Container Coord"
    for sample_info in rows_dicts[0]:
        ...
        biosample_name, errors_name, warnings_name = get_biosample_name(sample)
