...
from fms_core.services.sample import get_sample_from_container, transfer_sample, inherit_from_sample
...
class ExtractionRowHandler(GenericRowHandler):
    ...
    def process_row_inner(self, source_sample, resulting_sample, process_measurement):
        ...
        sample_destination = inherit_from_sample(original_sample)
