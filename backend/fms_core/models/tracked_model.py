...
class TrackedModel(models.Model):
    ...
    created_by = models.ForeignKey(User, null=False, blank=True, default=ADMIN_ID, related_name="%(app_label)s_%(class)s_creation", on_delete=models.PROTECT)
    updated_at = models.DateTimeField(auto_now=True, help_text="Date the instance was modified.")
    updated_by = models.ForeignKey(User, null=False, blank=True, default=ADMIN_ID, related_name="%(app_label)s_%(class)s_modification", on_delete=models.PROTECT)
