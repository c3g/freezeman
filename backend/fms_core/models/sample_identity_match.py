...
class SampleIdentityMatch(TrackedModel):
    ...
    matched = models.ForeignKey("SampleIdentity", on_delete=models.PROTECT, related_name="identity_match", help_text="Match found to be referencing this sample identity.")
