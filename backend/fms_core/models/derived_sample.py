...
class DerivedSample(TrackedModel):
    ...
    BIOSPECIMEN_TYPE_BUFFY_COAT = "BUFFY COAT"
    ...
    BIOSPECIMEN_TYPE_CHOICES = (
        *BIOSPECIMEN_TYPE_NA_CHOICES,
        ...
        (BIOSPECIMEN_TYPE_BUFFY_COAT, BIOSPECIMEN_TYPE_BUFFY_COAT),
    ...
    BIOSPECIMEN_TYPE_TO_TISSUE_SOURCE = {
        ...
        BIOSPECIMEN_TYPE_BUFFY_COAT: TISSUE_SOURCE_BUFFY_COAT,
    ...
    library = models.ForeignKey(Library, null=True, blank=True, on_delete=models.PROTECT, related_name="derived_sample", help_text="Library associated to this Derived Sample.")
