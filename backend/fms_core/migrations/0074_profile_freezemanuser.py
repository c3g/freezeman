    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(help_text="Name of the profile (e.g. 'TechDev', 'Production Lab', username, etc.)", max_length=200, unique=True, validators=[RegexValidator(re.compile('^[a-zA-Z0-9.\\-_ ]{1,200}$'))])),
                ('preferences', models.JSONField(blank=True, default=dict, help_text='Preferences stored as a JSON object')),
