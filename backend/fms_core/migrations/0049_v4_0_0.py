...
def initialize_workflows(apps, schema_editor):
    ...
    STEPS = [
        ...
        {"name": "Experiment Run DNBSEQ", "protocol_name": "DNBSEQ Preparation",
         "specifications": []},
        {"name": "Library Conversion (DNBSEQ)", "protocol_name": "Library Conversion",
         "specifications": [{"display_name": "New Library Platform", "sheet_name": "Conversion Batch", "column_name": "Platform", "value": "DNBSEQ"}]},
    ...
    WORKFLOWS = [
        ...
        # Ready-to-Sequence Conversion
        ("Ready-to-Sequence Conversion DNBSEQ", "Ready-to-Sequence Conversion", ["Library QC", "Library Conversion (DNBSEQ)", "Library QC", "Normalization (Library)", "Pooling", "Experiment Run DNBSEQ"])
    ]
