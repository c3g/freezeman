# Generated by Django 3.1 on 2022-06-22 18:58
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('completion_date', models.DateTimeField(blank=True, help_text='Date the dataset generation was completed.')),
                ('validation_date', models.DateTimeField(blank=True, help_text='Date the dataset was validated.')),
                ('sample_name', models.CharField(help_text='File produced for this sample', max_length=200)),
                ...
                ('dataset', models.ForeignKey(help_text='The dataset of the file', on_delete=django.db.models.deletion.PROTECT, to='fms_core.dataset')),
