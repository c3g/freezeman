    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_by', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='fms_core_samplekind_modification', to=settings.AUTH_USER_MODEL)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_at', models.DateTimeField(auto_now=True, help_text='Date the instance was modified.')),
                ('updated_by', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='fms_core_protocol_modification', to=settings.AUTH_USER_MODEL)),
                ('deleted', models.BooleanField(default=False, help_text='Whether this instance has been deleted.')),
            ],
        ),
        migrations.RunPython(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_at', models.DateTimeField(auto_now=True, help_text='Date the instance was modified.')),
                ('updated_by', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='fms_core_process_modification', to=settings.AUTH_USER_MODEL)),
                ('deleted', models.BooleanField(default=False, help_text='Whether this instance has been deleted.')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_at', models.DateTimeField(auto_now=True, help_text='Date the instance was modified.')),
                ('updated_by', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='fms_core_processsample_modification', to=settings.AUTH_USER_MODEL)),
                ('deleted', models.BooleanField(default=False, help_text='Whether this instance has been deleted.')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_at', models.DateTimeField(auto_now=True, help_text='Date the instance was modified.')),
                ('updated_by', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='fms_core_samplelineage_modification', to=settings.AUTH_USER_MODEL)),
                ('deleted', models.BooleanField(default=False, help_text='Whether this instance has been deleted.')),
            ],
        ),
        migrations.RenameField(
