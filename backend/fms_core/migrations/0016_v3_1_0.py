    ...
    for revision in revision_model.objects.filter(comment="Imported extracted samples from template.").all():
        ...
        if extracted_samples:
            ...
            for sample in extracted_samples:
                ...
                extracted_samples_info.update({sample.object_id: {"process": pr, "comment": comment}})
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_by', models.ForeignKey(null=True, blank=True, default=ADMIN_USER_ID, on_delete=django.db.models.deletion.SET_NULL, related_name='fms_core_samplekind_creation', to=settings.AUTH_USER_MODEL)),
                ('updated_at', models.DateTimeField(auto_now=True, help_text='Date the instance was modified.')),
                ('updated_by', models.ForeignKey(null=True, blank=True, default=ADMIN_USER_ID, on_delete=django.db.models.deletion.SET_NULL, related_name='fms_core_samplekind_modification', to=settings.AUTH_USER_MODEL)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True, help_text='Date the instance was created.')),
                ('created_by', models.ForeignKey(null=True, blank=True, default=ADMIN_USER_ID, on_delete=django.db.models.deletion.SET_NULL, related_name='fms_core_protocol_creation', to=settings.AUTH_USER_MODEL)),
                ('updated_at', models.DateTimeField(auto_now=True, help_text='Date the instance was modified.')),
                ('updated_by', models.ForeignKey(null=True, blank=True, default=ADMIN_USER_ID, on_delete=django.db.models.deletion.SET_NULL, related_name='fms_core_protocol_modification', to=settings.AUTH_USER_MODEL)),
                ('deleted', models.BooleanField(default=False, help_text='Whether this instance has been deleted.')),
            ],
        ),
        migrations.RunPython(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True, help_text='Date the instance was created.')),
                ('created_by', models.ForeignKey(null=True, blank=True, default=ADMIN_USER_ID, on_delete=django.db.models.deletion.SET_NULL, related_name='fms_core_process_creation', to=settings.AUTH_USER_MODEL)),
                ('updated_at', models.DateTimeField(auto_now=True, help_text='Date the instance was modified.')),
                ('updated_by', models.ForeignKey(null=True, blank=True, default=ADMIN_USER_ID, on_delete=django.db.models.deletion.SET_NULL, related_name='fms_core_process_modification', to=settings.AUTH_USER_MODEL)),
                ('deleted', models.BooleanField(default=False, help_text='Whether this instance has been deleted.')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True, help_text='Date the instance was created.')),
                ('created_by', models.ForeignKey(null=True, blank=True, default=ADMIN_USER_ID, on_delete=django.db.models.deletion.SET_NULL, related_name='fms_core_processsample_creation', to=settings.AUTH_USER_MODEL)),
                ('updated_at', models.DateTimeField(auto_now=True, help_text='Date the instance was modified.')),
                ('updated_by', models.ForeignKey(null=True, blank=True, default=ADMIN_USER_ID, on_delete=django.db.models.deletion.SET_NULL, related_name='fms_core_processsample_modification', to=settings.AUTH_USER_MODEL)),
                ('deleted', models.BooleanField(default=False, help_text='Whether this instance has been deleted.')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True, help_text='Date the instance was created.')),
                ('created_by', models.ForeignKey(null=True, blank=True, default=ADMIN_USER_ID, on_delete=django.db.models.deletion.SET_NULL, related_name='fms_core_samplelineage_creation', to=settings.AUTH_USER_MODEL)),
                ('updated_at', models.DateTimeField(auto_now=True, help_text='Date the instance was modified.')),
                ('updated_by', models.ForeignKey(null=True, blank=True, default=ADMIN_USER_ID, on_delete=django.db.models.deletion.SET_NULL, related_name='fms_core_samplelineage_modification', to=settings.AUTH_USER_MODEL)),
                ('deleted', models.BooleanField(default=False, help_text='Whether this instance has been deleted.')),
            ],
        ),
        migrations.RenameField(
