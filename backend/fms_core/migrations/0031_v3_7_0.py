    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('value',
                 models.CharField(help_text='The nucleotide string defining the sequence.', max_length=500, unique=True,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_by', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.PROTECT,
                                                 ...
                                                 to=settings.AUTH_USER_MODEL)),
                ('flanker_3prime_forward', models.ForeignKey(help_text="Flanker on the 3' forward direction",
                                                             on_delete=django.db.models.deletion.PROTECT,
                                                             related_name='flanker_3prime_forward',
                                                             to='fms_core.sequence')),
                ('flanker_3prime_reverse', models.ForeignKey(help_text="Flanker on the 3' reverse direction",
                                                             on_delete=django.db.models.deletion.PROTECT,
                                                             related_name='flanker_3prime_reverse',
                                                             to='fms_core.sequence')),
                ('flanker_5prime_forward', models.ForeignKey(help_text="Flanker on the 5' forward direction",
                                                             on_delete=django.db.models.deletion.PROTECT,
                                                             related_name='flanker_5prime_forward',
                                                             to='fms_core.sequence')),
                ('flanker_5prime_reverse', models.ForeignKey(help_text="Flanker on the 5' reverse direction",
                                                             on_delete=django.db.models.deletion.PROTECT,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(help_text='The name of the index.', max_length=200, unique=True, validators=[
                    django.core.validators.RegexValidator(re.compile('^[a-zA-Z0-9.\\-_]{1,200}$'))])),
                ('index_set', models.ForeignKey(help_text='The set which this index belongs to',
