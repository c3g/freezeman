    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_at', models.DateTimeField(auto_now=True, help_text='Date the instance was modified.')),
                ('deleted', models.BooleanField(default=False, help_text='Whether this instance has been deleted.')),
                ('value', models.CharField(help_text='The nucleotide string defining the sequence.', max_length=500, unique=True, validators=[django.core.validators.RegexValidator(re.compile('^[ATCGU]{1,500}$'))])),
                ('created_by', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.PROTECT, related_name='fms_core_sequence_creation', to=settings.AUTH_USER_MODEL)),
                ('updated_by', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.PROTECT, related_name='fms_core_sequence_modification', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_by', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.PROTECT, related_name='fms_core_indexstructure_creation', to=settings.AUTH_USER_MODEL)),
                ('flanker_3prime_forward', models.ForeignKey(help_text="Flanker on the 3' forward direction", on_delete=django.db.models.deletion.PROTECT, related_name='flanker_3prime_forward', to='fms_core.sequence')),
                ('flanker_3prime_reverse', models.ForeignKey(help_text="Flanker on the 3' reverse direction", on_delete=django.db.models.deletion.PROTECT, related_name='flanker_3prime_reverse', to='fms_core.sequence')),
                ('flanker_5prime_forward', models.ForeignKey(help_text="Flanker on the 5' forward direction", on_delete=django.db.models.deletion.PROTECT, related_name='flanker_5prime_forward', to='fms_core.sequence')),
                ('flanker_5prime_reverse', models.ForeignKey(help_text="Flanker on the 5' reverse direction", on_delete=django.db.models.deletion.PROTECT, related_name='flanker_5prime_reverse', to='fms_core.sequence')),
                ('updated_by', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.PROTECT, related_name='fms_core_indexstructure_modification', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_by', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.PROTECT, related_name='fms_core_indexset_creation', to=settings.AUTH_USER_MODEL)),
                ('updated_by', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.PROTECT, related_name='fms_core_indexset_modification', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.AddField(
            ...
            name='index',
            field=models.ForeignKey(help_text='Index associated to this Derived Sample used to form a Library', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='derived_samples', to='fms_core.index'),
        ),
    ]
