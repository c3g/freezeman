...
TemplateDefinition = TypedDict('TemplateDefinition', {
    ...
    'prefill info': NotRequired[list[tuple[str, str, str | None, str | None] | tuple[str, str, str | None, str | None, Callable[[Any]] | None]]],
...
SAMPLE_RENAME_TEMPLATE: TemplateDefinition = {
  "identity": {
      ...
      "workbook": sample_rename_workbook_generator
    },
  "sheets info": [
      {
          'name': 'SampleRename',
