...
const api = {
	...
	derivedSamples: {
		...
		list: (options: QueryParams, abort?: boolean) =>
			get<JsonResponse<FMSPagedResultsReponse<FMSDerivedSample>>>(`/derivedsamples/`, options, { abort }),
	},

	experimentRuns: {
		get: (experimentRunId) => get(`/experiment-runs/${experimentRunId}/`),
		list: (options, abort?: boolean, requestID?: string) =>
			get<JsonResponse<FMSPagedResultsReponse<FMSExperimentRun>>>('/experiment-runs/', options, { abort, requestID }),
		...
		getLaneValidationStatus: (experimentRunId, lane) =>
			get(`/experiment-runs/${experimentRunId}/get_experiment_run_lane_validation_status/`, { lane }),
	},
	...
	pooledSamples: {
		list: (options: any, apiOptions?: APIFetchOptions) =>
			get<JsonResponse<FMSPagedResultsReponse<FMSPooledSample>>>('/pooled-samples/', options, apiOptions),
		...
		prefill: {
			...
			request: (options: any, template: number) =>
				filteredpost(`/pooled-samples/prefill_template/`, { ...options }, form({ template: template })),
		},
	},
	...
	projects: {
		...
		list: (options, abort?: boolean, requestID?: string) =>
			get<JsonResponse<FMSPagedResultsReponse<FMSProject>>>('/projects/', options, { abort, requestID }),
	...
	protocols: {
		...
		lastProtocols: (options, abort?: boolean) =>
			get<JsonResponse<{ sample_result: FMSSample['id']; protocol: FMSProtocol['name'] }[]>>('/protocols/last_protocols/', options, {
				abort,
			}),
	},
	...
	sampleIdentity: {
		...
		list: (options: any, abort?: boolean) =>
			get<JsonResponse<FMSPagedResultsReponse<FMSSampleIdentity>>>(`/sample-identities/`, options, { abort }),
	},

	sampleIdentityMatch: {
		get: (id: FMSSampleIdentityMatch['id']) => get<JsonResponse<FMSSampleIdentityMatch>>(`/sample-identity-matches/${id}/`),
		list: (options: any, abort?: boolean) =>
			get<JsonResponse<FMSPagedResultsReponse<FMSSampleIdentityMatch>>>(`/sample-identity-matches/`, options, { abort }),
	},
	...
	sampleNextStep: {
		...
		labworkStepSummary: (stepId: FMSId, groupBy: string, options?: QueryParams, sample__id__in?: FMSId[]) =>
	...
	sampleNextStepByStudy: {
		getStudySamples: (options: any) =>
			get<JsonResponse<FMSPagedResultsReponse<FMSSampleNextStepByStudy>>>('/sample-next-step-by-study/', { ...options }),
		getStudySamplesForStepOrder: (studyId, stepOrderID, options) =>
			get(`/sample-next-step-by-study/`, { ...options, study__id__in: studyId, step_order__id__in: stepOrderID }),
	...
	samplesheets: {
		getSamplesheet: (barcode, kind, placementData) =>
			post('/samplesheets/get_samplesheet/', { container_barcode: barcode, container_kind: kind, placement: placementData }),
	},
	...
	stepHistory: {
		getCompletedSamplesForStudy: (studyId, options) =>
			get<JsonResponse<FMSPagedResultsReponse<FMSStepHistory>>>('/step-histories/', { ...options, study__id__in: studyId }),
	...
	report: {
		...
		getReport: (name: string, start_date: string, end_date: string, time_window = 'month', group_by: string[] = []) =>
			get<JsonResponse<FMSReportData>>(`/reports/${name}/`, { group_by, time_window, start_date, end_date }),
		getReportAsExcel: (name: string, start_date: string, end_date: string, time_window = 'month', group_by: string[] = []) =>
			get<ArrayBufferResponse>(`/reports/${name}/`, { group_by, time_window, start_date, end_date, export: true }),
	},
}
