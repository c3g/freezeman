...
const api = {
  ...
  biosamples: {
    ...
    list: (options: QueryParams, abort?: boolean) =>
      get<JsonResponse<FMSPagedResultsReponse<FMSBiosample>>>(`/biosamples/`, options, { abort }),
  },
  ...
  datasets: {
    ...
    list: (options, abort?: boolean) =>
      get<JsonResponse<FMSPagedResultsReponse<FMSDataset>>>("/datasets/", options, { abort }),
    setReleaseStatus: (id: FMSDataset["id"], updates: Record<FMSReadset["id"], ReleaseStatus>) =>
  ...
  experimentRuns: {
    ...
    list: (options, abort?: boolean, requestID?: string) =>
      get<JsonResponse<FMSPagedResultsReponse<FMSExperimentRun>>>("/experiment-runs/", options, {
        abort,
        requestID,
      }),
  ...
  pooledSamples: {
    list: (options: any, apiOptions?: APIFetchOptions) =>
      get<JsonResponse<FMSPagedResultsReponse<FMSPooledSample>>>(
        "/pooled-samples/",
        options,
        apiOptions,
      ),
    ...
    prefill: {
      templates: () =>
        get<JsonResponse<FMSTemplatePrefillOption[]>>(`/pooled-samples/list_prefills/`),
  ...
  projects: {
    ...
    list: (options, abort?: boolean, requestID?: string) =>
      get<JsonResponse<FMSPagedResultsReponse<FMSProject>>>("/projects/", options, {
        abort,
        requestID,
      }),
  ...
  protocols: {
    ...
    lastProtocols: (options, abort?: boolean) =>
      get<JsonResponse<{ sample_result: FMSSample["id"]; protocol: FMSProtocol["name"] }[]>>(
  ...
  samples: {
    ...
    addSamplesToStudy: (
      exceptedSampleIDs: Array<FMSSample["id"]>,
      ...
      filteredpost<StringResponse>(`/samples/add_samples_to_study/`, queryParams, {
    ...
    list: (options, abort?: boolean) =>
      get<JsonResponse<FMSPagedResultsReponse<FMSSample>>>("/samples/", options, { abort }),
  ...
  sampleIdentity: {
    get: (id: FMSSampleIdentity["id"]) =>
      get<JsonResponse<FMSSampleIdentity>>(`/sample-identities/${id}/`),
    list: (options: any, abort?: boolean) =>
      get<JsonResponse<FMSPagedResultsReponse<FMSSampleIdentity>>>(`/sample-identities/`, options, {
        abort,
      }),
  },
  ...
  sampleIdentityMatch: {
    get: (id: FMSSampleIdentityMatch["id"]) =>
      get<JsonResponse<FMSSampleIdentityMatch>>(`/sample-identity-matches/${id}/`),
    list: (options: any, abort?: boolean) =>
      get<JsonResponse<FMSPagedResultsReponse<FMSSampleIdentityMatch>>>(
  ...
  sampleNextStep: {
    listSamples: (sampleIDs: FMSId[]) =>
      get<JsonResponse<FMSPagedResultsReponse<FMSSampleNextStep>>>("/sample-next-step/", {
    ...
    labworkStepSummary: (
      ...
      filteredpost<JsonResponse<LabworkStepInfo>>(
    ...
    listSamplesAtStep: (stepId: FMSId, options?: QueryParams, sample__id__in?: FMSId[]) =>
      filteredpost<JsonResponse<FMSPagedResultsReponse<FMSSampleNextStep>>>(
    ...
    prefill: {
      ...
      request: (
        ...
        filteredpost<ArrayBufferResponse>(
  ...
  sampleNextStepByStudy: {
    getStudySamples: (options: any) =>
      get<JsonResponse<FMSPagedResultsReponse<FMSSampleNextStepByStudy>>>(
    ...
    removeList: (sampleIDs: FMSId[], study: FMSStudy["id"], stepOrder: number) =>
      post<JsonResponse<Array<FMSSample["id"]>>>(`/sample-next-step-by-study/destroy_list/`, {
  ...
  stepHistory: {
    getCompletedSamplesForStudy: (studyId, options) =>
      get<JsonResponse<FMSPagedResultsReponse<FMSStepHistory>>>("/step-histories/", {
        ...options,
        study__id__in: studyId,
      }),
  ...
  steps: {
    list: (options, abort?: boolean) =>
      get<JsonResponse<FMSPagedResultsReponse<FMSStep>>>("/steps/", options, { abort }),
  },
  ...
  sample_lineage: {
    get: (sampleId: FMSId) =>
      get<JsonResponse<FMSSampleLineageGraph>>(`/sample-lineage/${sampleId}/graph/`),
  },

  report: {
    listReports: () => get<JsonResponse<{ name: string; display_name: string }[]>>("/reports/"),
    listReportInformation: (name: string) =>
      get<JsonResponse<FMSReportInformation>>(`/reports/${name}/`),
    getReport: (
      name: string,
      start_date: string,
      end_date: string,
      ...
      get<JsonResponse<FMSReportData>>(`/reports/${name}/`, {
        group_by,
        time_window,
        start_date,
        end_date,
    ...
    getReportAsExcel: (
      ...
      get<ArrayBufferResponse>(`/reports/${name}/`, {
        group_by,
        time_window,
        start_date,
        end_date,
...
export function dispatchForApi<T>(
  token: string | undefined,
  thunk: (_: Dispatch<AnyAction>, getState: () => AuthTokensAccess) => T,
): T {
...
export function withToken<R extends ResponseWithData<any>, Args extends any[]>(
  token: string | undefined,
  fn: WithTokenFn<R, Args>,
) {
...
function get<R extends ResponseWithData<any>>(
  route: string,
  queryParams?: QueryParams,
...
function filteredpost<R extends ResponseWithData<any>>(
  route: string,
  queryParams: QueryParams,
  body: any,
  options?: APIFetchOptions,
...
function post<R extends ResponseWithData<any>>(
  route: string,
  body: any,
  options?: APIFetchOptions,
) {
...
function patch<R extends ResponseWithData<any>>(
  route: string,
  body: any,
  options?: APIFetchOptions,
) {
...
type ResponseWithData<T = any> =
  JsonResponse<T> | ArrayBufferResponse | StringResponse | AttachDataErrorResponse

function attachData<R extends ResponseWithData<any>>(
  response: Response & Partial<ResponseWithData>,
) {
