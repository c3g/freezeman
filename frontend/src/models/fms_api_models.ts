...
export interface FMSPooledSample extends FMSTrackedModel {
  ...
  pool_name: string // The name of the pool or "pool" (a sample with a single derived sample)
...
/**
 * Freezeman parent project model
 */
...
export interface ProtocolPropertyType {
  // Subfield of FMSProtocol
...
export type WorkflowActionType =
  "NEXT_STEP" | "DEQUEUE_SAMPLE" | "REPEAT_STEP" | "REPEAT_QC_STEP" | "IGNORE_WORKFLOW"
...
export interface WorkflowStepOrder {
  // Not a tracked model - just a simple serialized object
...
export interface FMSSampleLineageGraph {
  ...
  edges: (Pick<FMSProcessMeasurement, "id" | "source_sample" | "child_sample"> & {
