...
export const SAMPLE_NEXT_STEP_BY_STUDY_FILTER_KEYS: { [key in SampleColumnID]: string } = {
	...
	[SampleColumnID.PARENT_COORDINATES]: 'sample_next_step__sample__container__location__coordinate__name',
...
export const SAMPLE_FILTER_KEYS: { [key in SampleColumnID]: string } = {
	...
	[SampleColumnID.PARENT_COORDINATES]: 'container__location__coordinate__name',
