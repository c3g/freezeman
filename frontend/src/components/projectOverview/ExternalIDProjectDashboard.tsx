...
import { CheckCircleOutlined, FolderOpenOutlined, TeamOutlined, UserOutlined } from '@ant-design/icons'
        ...
        <Row gutter={[16, 16]} justify="center" style={{ margin: '12px 0' }}>
            <Col xs={24} sm={12} md={6}>
                <Card size="small" style={dashboardCardStyle}>
                    <Statistic title="Total Projects" value={total} prefix={<FolderOpenOutlined style={iconStyle('#1677ff')} />} />
                </Card>
            </Col>

            <Col xs={24} sm={12} md={6}>
                <Card size="small" style={dashboardCardStyle}>
                    <Statistic title="Open Projects" value={openCount} 
            ...
            <Col xs={24} sm={12} md={6}>
                <Card size="small" style={dashboardCardStyle}>
                    <Statistic title="Principal Investigators" value={uniquePIs}  
            ...
            <Col xs={24} sm={12} md={6}>
                <Card size="small" style={dashboardCardStyle}>
                    <Statistic title="Requestors" value={uniqueRequestors} 
