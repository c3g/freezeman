...
export default function useExpandableTableDatasetComments(): NonNullable<TableProps<any>['expandable']> {
    return useMemo(() => {
                ...
                expandIcon: ({ expanded, onExpand, record }) =>
                    expanded ? (
                        <Tooltip title="Hide Comments">
                            <MinusCircleTwoTone style={{ fontSize: 18 }} onClick={e => onExpand(record, e)} onPointerEnterCapture={undefined} onPointerLeaveCapture={undefined} />
                        </Tooltip>
                    ) : (
                        <Tooltip title="View Comments">
                            <PlusCircleTwoTone style={{ fontSize: 18 }} onClick={e => onExpand(record, e)} onPointerEnterCapture={undefined} onPointerLeaveCapture={undefined} />
                        </Tooltip>
