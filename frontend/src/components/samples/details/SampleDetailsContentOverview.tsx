...
import { Descriptions, Table, Row, Col, Card, Empty, Timeline, DescriptionsProps, TableProps, Typography } from "antd";
...
export default function SampleDetailsContentOverview({ sampleID }: SampleDetailsContentOverviewProps) {
    ...
    render.push(
        <Title level={2} style={{ marginTop: '1rem' }} key={'versions-title'}>Versions</Title>,
