...
import { createPagedItemsActionTypes, createPagedItemsActions } from "../../utils/paged_items_factory";
...
const prefix = "INDICES.TABLE"
const pagedActionTypes = createPagedItemsActionTypes(prefix)
...
export default {
    ...
    listTemplateActions,
    validate,
    ...createPagedItemsActions(pagedActionTypes, prefix, list)
};
