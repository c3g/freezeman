...
import { clickCellHelper, initialState, multiSelectionHelper, reducerWithThrows, loadContainerHelper, placeAllSourceHelper, onCellEnterHelper, onCellExitHelper, undoSelectedSamplesInContainerHelper, flushContainersHelper } from "./helpers"
...
const slice = createSlice({
    ...
    reducers: {
        ...
        undoSelectedSamples: reducerWithThrows(undoSelectedSamplesInContainerHelper),
