...
export const LIST_BY_COLLECTION    = createNetworkActionTypes("SAMPLES.LIST_BY_COLLECTION");
...
export const listByCollection = ({offset = 0,  filters, sortBy, limit = DEFAULT_PAGINATION_LIMIT } = {}, abort) => async (dispatch, getState) => {

  //Prevents the default fetch without any filters
  if (filters && !filters["projects__id"]["value"])
      return
  ...
  return await dispatch(networkAction(LIST_BY_COLLECTION,
